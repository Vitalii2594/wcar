      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <div key={index} className={`relative bg-gray-800 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-cyan-500/20 border ${plan.popular ? 'border-cyan-400 scale-105 shadow-cyan-500/25' : 'border-gray-700'}`}>
              {plan.popular && (
